...
namespace Drupal\ga_memory\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

class MemorySettingsForm extends ConfigFormBase {
  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'ga_memory_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('ga_memory.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state, $plugin_id = NULL, $langcode = NULL) {
    ...
    $config = \Drupal::service('config.factory')
      ->getEditable('ga_memory.settings');
